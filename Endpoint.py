...
api_token = 'b3a9f284e77aa2ac135c755fa6dab100'
client_token = 'eab6bad1a899972bd2bbde194ac11404b3c4bd32efc6f73dd19d07ccd382d8c8'
        ...
        try:
            ...
            if r[0] == 'GET':
                ...
                if data['type'] == 'issue':
                    ...
                    payload = {'name':title.upper(),'desc':data['description'],'idList':'62517722f26860129a457745','idLabels':['625177222d2ecec5005b168d',]}
                    re = requests.post(url,params=args,json=payload)
